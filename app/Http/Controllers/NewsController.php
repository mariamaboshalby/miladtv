...
class NewsController extends Controller
{
    private function getAllNews()
    {
        return [
            ...
            [
                'id' => 3,
                'title' => 'milad Opens New Branch in Alexandria',
                'excerpt' => 'As part of its expansion plan, milad opens a new branch in Alexandria to serve customers on the North Coast.',
            ...
            [
                ...
                'excerpt' => 'milad offers discounts of up to 40% on all printers.',
                'content' => 'milad is offering exceptional deals on all printers and products. Discounts reach up to 40% on HP, Canon, Epson, and Brother printers. Offers are valid with free delivery across Egypt.',
            ...
            [
                ...
                'content' => 'Brother has won the Best Office Printer award from TechReview magazine for 2026. The award was given to the HL-L9310CDW for its exceptional quality, high reliability, and low running costs. milad is proud to be the official distributor of Brother products in Egypt.',
                'category' => 'Awards',
                'date' => '2026-03-15',
                'image' => 'news6',
                'author' => 'milad Team',
